...
class UIMainMenu(UI):
    def __init__(self) -> None:
        ...
        self.__background = Background(self.__colors.COLOR_WHITE,(self.__game_settings.SCREEN_WIDTH, self.__game_settings.SCREEN_HEIGHT))
        ...
        self.__support_position = (self.__game_settings.SCREEN_WIDTH // 2, self.__game_settings.SCREEN_HEIGHT - (self.__game_settings.SCREEN_HEIGHT * 0.07))
